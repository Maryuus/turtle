...
echo "=== CORRECTION LECTURE CARTE (RESPECT DES ESPACES) ==="

# -----------------------------------------------------------------------------
# 1. JARDIN SOURCE (jardin.cc) - Nouvelle lecture avec std::getline
# -----------------------------------------------------------------------------
cat << 'EOF' > GUI/jardin.cc
#include "jardin.hh"
...
# -----------------------------------------------------------------------------
echo "=== RECOMPILATION ==="
rm -f jardin.o main.o tortue
make

echo "=== TEST VISUEL ==="
./tortue test_complet.txt
